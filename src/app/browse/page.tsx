  ...
  return (
    <div className="container mx-auto px-4 py-12 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-16">
         <Link 
            href="/browse/sounds"
            className={`flex-1 h-14 md:h-16 flex items-center justify-center gap-3 border border-slate-200/80 text-lg md:text-xl font-bold uppercase tracking-wider transition-all rounded-xl shadow-sm ${type === 'packs' ? 'bg-[#000000] text-white border-[#000000]' : 'bg-white hover:bg-slate-50 text-slate-600 hover:text-slate-800'}`}
         >
            <Music size={18} />
            Sounds
         ...
         <Link 
            href="/browse/presets"
            className={`flex-1 h-14 md:h-16 flex items-center justify-center gap-3 border border-slate-200/80 text-lg md:text-xl font-bold uppercase tracking-wider transition-all rounded-xl shadow-sm ${type === 'presets' ? 'bg-[#000000] text-white border-[#000000]' : 'bg-white hover:bg-slate-50 text-slate-600 hover:text-slate-800'}`}
         >
            <Sparkles size={18} />
            Producer Presets
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <aside className="lg:col-span-3 lg:sticky lg:top-32 space-y-6 order-2 lg:order-1">
           <div className="bg-white border border-slate-200/80 rounded-xl p-5 space-y-6 shadow-sm">
              ...
              <div className="space-y-2">
                 <Link 
                   ...
                   className="block w-full p-2.5 bg-slate-50 border border-slate-200/60 rounded-lg text-[10px] font-bold uppercase tracking-wider text-slate-600 hover:bg-[#000000] hover:text-white hover:border-[#000000] text-center transition-all"
                 >
                    All Genres
                 </Link>
           ...
           <div className="p-4 bg-sky-50 border border-sky-100 rounded-xl">
              <div className="flex items-center gap-2 text-[#000000] mb-1.5">
                 <ShoppingBag size={14} />
              ...
              <p className="text-[11px] font-bold uppercase tracking-tight text-slate-700">
                 Get any {type === 'packs' ? 'Pack' : 'Preset'} for <span className="text-[#000000] font-extrabold">$9.99</span>
              </p>
           </div>
        </aside>
        ...
        <main className="lg:col-span-9 order-1 lg:order-2 min-h-[600px]">
          {type === 'packs' ? (
             <div className="space-y-8">
                <div className="space-y-1">
                   <h1 className="text-3xl md:text-4xl font-extrabold uppercase tracking-tight text-slate-900">
                      Premium <span className="text-[#000000]">Packs</span>
                   </h1>
             ...
             <div className="space-y-8">
                <div className="space-y-1">
                   <h1 className="text-3xl md:text-4xl font-extrabold uppercase tracking-tight text-slate-900">
                      Signature <span className="text-[#000000]">Presets</span>
                   </h1>
